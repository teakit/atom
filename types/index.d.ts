...
import * as compose from "@teakit/compose";
...
declare namespace Application {
  ...
  /**
   * This interface can be augmented by users to add types to Atom's default state
   */
  interface DefaultState extends DefaultStateExtends {}

  type DefaultContextExtends = {};
  /**
   * This interface can be augmented by users to add types to Atom's default context
   */
  ...
  interface ExtendableContext extends BaseContext {
    ...
    accept: accepts.Accepts;
    /**
     * To bypass Atom's built-in response handling, you may explicitly set `ctx.respond = false;`
     */
