...
describe("contentDisposition(filename, options)", () => {
  describe('with "fallback" option', () => {
    ...
    describe('when "false"', () => {
      ...
      it("should keep ISO-8859-1 filename", () => {
        ...
        assert.strictEqual(ctx.response.header["content-disposition"], 'attachment; filename="£ rates.pdf"');
      });
    });
    ...
    describe("when a string", () => {
      ...
      it("should do nothing if equal to filename", () => {
        ...
        assert.strictEqual(ctx.response.header["content-disposition"], 'attachment; filename="plans.pdf"');
      });
  ...
  describe('with "type" option', () => {
    ...
    it("should create a header with inline type and filename", () => {
      ...
      assert.strictEqual(ctx.response.header["content-disposition"], 'inline; filename="plans.pdf"');
    });
